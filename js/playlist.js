...
for (var i = 0; i < playlist.length; i++) {
    ...
    var spanArtista = document.createElement("span1");

    h3.innerText = playlist[i].name; //<h3>nome da musica</h3>
    spanAlbum.innerText = playlist[i].album.name; //<span>nome da album</span>
    spanArtista.innerText = playlist[i].artists;

    spanAlbum.classList.add("album"); // <span class="album">...
